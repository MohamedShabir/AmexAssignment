package com.qa.amexassesement.listeners;
...
import static com.qa.amexassesement.factory.PlaywrightFactory.takeScreenshot;
...
//		Get Local IP Address
		...
		reporter.config().setReportName("Amex FR All Credit Card Automation Test Results");
		extentReports.attachReporter(reporter);
		extentReports.setSystemInfo("Local Host", localHost.getHostAddress());
		extentReports.setSystemInfo("HostName", hostName);
		extentReports.setSystemInfo("Author", "Mohamed Shabir");
		extentReports.setSystemInfo("Build#", "1.1");
		extentReports.setSystemInfo("Customer Name", "Amex FR Credit Card Transactions");
